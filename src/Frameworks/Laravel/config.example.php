...
return [
    ...
    */
    ...
    'credentials' => [
        ...
        // 'ollama' => [
        //     'type' => OllamaProvider::class,
        // ],

        'azure' => [
            'type' => AzureProvider::class,
            'api_key' => env('AZURE_API_KEY'),
            'organization' => env('AZURE_ORGANISATION', env('AZURE_ORGANIZATION')),
            'project_id' => env('AZURE_PROJECT_ID'),
        ],
    ],
    ...
    */
    ...
    'embed_models' => [
        ...
        'azure-text-embedding-3-small' => [
            'type' => AzureEmbedModel::class,
            'client' => AzureEmbedApiClient::class,
            'url' => env('OPENAI_EMBEDDINGS_URL', 'https://xxx.openai.azure.com/openai/deployments/xxx/chat/completions?api-version=2024-10-21'),
            'credentials' => 'azure',
            'custom_headers' => [],
