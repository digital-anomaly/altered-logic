...
/**
 * Registry group for EmbedModel instances.
 *
 * @extends AbstractRegistryGroup<EmbedModelInterface>
 */
class EmbedModelRegistryGroup extends AbstractRegistryGroup
{
    /** @var string The name of the group. */
    protected string $registryName = 'embed-model';
    ...
    protected static function frameworkResolveDefaultEntityName(
        ...
        return match ($framework) {
            FrameworksEnum::Laravel => LaravelFrameworkRegistryBuilder::getDefaultEmbedModelName($checkExists),
            default => null,
        };
    }
     ...
     */
    protected static function frameworkBuildEntity(FrameworksEnum $framework, string $name): ?EmbedModelInterface
    {
        // todo - add other frameworks
        return match ($framework) {
            FrameworksEnum::Laravel => LaravelFrameworkRegistryBuilder::buildEmbedModel($name),
            default => null,
        };
    }
}
