...
/**
 * Registry group for DocStore instances.
 *
 * @extends AbstractRegistryGroup<DocStoreInterface>
 */
class DocStoreRegistryGroup extends AbstractRegistryGroup
{
    /** @var string The name of the group. */
    protected string $registryName = 'doc-store';
    ...
    protected static function frameworkResolveDefaultEntityName(
        ...
        // Doc-stores don't have defaults - they're only accessible via DocumentProfiles
        return null;
    }
     ...
     */
    protected static function frameworkBuildEntity(FrameworksEnum $framework, string $name): ?DocStoreInterface
    {
        // todo - add other frameworks
        return match ($framework) {
            FrameworksEnum::Laravel => LaravelFrameworkRegistryBuilder::buildDocStore($name),
            default => null,
        };
    }
}
