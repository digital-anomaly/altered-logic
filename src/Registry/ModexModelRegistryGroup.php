...
/**
 * Registry group for ModexModel instances.
 *
 * @extends AbstractRegistryGroup<ModexModelInterface>
 */
class ModexModelRegistryGroup extends AbstractRegistryGroup
{
    /** @var string The name of the group. */
    protected string $registryName = 'modex-model';
    ...
    protected static function frameworkResolveDefaultEntityName(
        ...
        return match ($framework) {
            FrameworksEnum::Laravel => LaravelFrameworkRegistryBuilder::getDefaultModexModelName($checkExists),
            default => null,
        };
    }
     ...
     */
    protected static function frameworkBuildEntity(FrameworksEnum $framework, string $name): ?ModexModelInterface
    {
        // todo - add other frameworks
        return match ($framework) {
            FrameworksEnum::Laravel => LaravelFrameworkRegistryBuilder::buildModexModel($name),
            default => null,
        };
    }
}
