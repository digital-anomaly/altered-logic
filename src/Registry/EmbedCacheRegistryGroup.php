...
/**
 * Registry group for EmbedCache instances.
 *
 * @extends AbstractRegistryGroup<EmbedCacheInterface>
 */
class EmbedCacheRegistryGroup extends AbstractRegistryGroup
{
    /** @var string The name of the group. */
    protected string $registryName = 'embed-cache';
    ...
    protected static function frameworkResolveDefaultEntityName(
        ...
        return match ($framework) {
            FrameworksEnum::Laravel => LaravelFrameworkRegistryBuilder::getDefaultEmbedCacheName($checkExists),
            default => null,
        };
    }
     ...
     */
    protected static function frameworkBuildEntity(FrameworksEnum $framework, string $name): ?EmbedCacheInterface
    {
        // todo - add other frameworks
        return match ($framework) {
            FrameworksEnum::Laravel => LaravelFrameworkRegistryBuilder::buildEmbedCache($name),
            default => null,
        };
    }
}
